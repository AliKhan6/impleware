...
class AddMedication extends StatelessWidget {
  ...
  const AddMedication({Key? key, this.list}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) => AddMedicineViewModel(),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  }, context, time: model.medicine.time1),
                                  ...
                                  }, context, time: model.medicine.time2),
                                  // time 3
                                  remindersTile(model, () {
                                  ...
                                  }, context, time: model.medicine.time3),
